...
export default function ProductItem({
  ...
  return (
    <div className="product-item w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 p-3 ">
      <div className="wraper flex flex-col h-full">
        <Link href={`/productdetails/${product._id}`} className="flex-1">
          <div className="item relative">
            ...
            <div className="flex justify-between items-center">
              <div className="price my-2 min-h">
                <p
                  className={
              ...
              {product.quantity === 0 ? <p className="text-red-400">❌ Out of stock</p> : <p className="text-green-300">✅ In stock</p>}
          </div>
        </Link>
